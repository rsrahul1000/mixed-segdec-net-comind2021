...
train_MVTEC() {
    ...
    #       mkdir -p $RESULTS_PATH/MVTEC/$RUN_NAME/FOLD_$class && python -u train_net.py --GPU=${GPUS[$N-1]} --FOLD=$class $RUN_ARGS | /usr/bin/tee $LOG_REDIRECT &
